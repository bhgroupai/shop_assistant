...
REPLY_THREE = (
    "1. Krossovka Nike Air · 350000 · 40,41,42 · 2026-09-12 · https://t.me/example_shop/1300\n"
    "2. Dvoyka · 980000 · M,L,XL · 2026-09-13 · https://t.me/example_shop/1301\n"
    "3. Dvoyka · 980000 · M,L,XL,2XL · 2026-09-10 · https://t.me/example_shop/1234\n"
...
def test_duplicate_link_kept_once_at_first_position():
    text = (
        "1. Krossovka Nike Air · 350000 · https://t.me/example_shop/1300\n"
        "2. Dvoyka · 980000 · https://t.me/example_shop/1234\n"
        "Eslatma: Krossovka Nike Air uchun obunachilarga 320000 — https://t.me/example_shop/1300"
    )
...
def test_at_most_five_ids():
    ...
    text = "\n".join(f"{n}. Mahsulot · https://t.me/example_shop/{i}" for n, i in enumerate(ids, 1))
...
def test_other_channel_links_ignored():
    ...
    mixed = (
        ...
        "2. Krossovka Nike Air · 350000 · https://t.me/example_shop/1300\n"
        "3. Dvoyka · 980000 · https://t.me/example_shop/1234"
    )
    assert post_ids_in(mixed) == [1300, 1234]


def test_bare_and_https_forms_accepted():
    assert post_ids_in("Ha, bor: t.me/example_shop/1300") == [1300]
    assert post_ids_in("Ha, bor: https://t.me/example_shop/1300") == [1300]


def test_link_followed_by_punctuation():
    assert post_ids_in("Mana bu: https://t.me/example_shop/1300.") == [1300]
    assert post_ids_in("Mana bu (https://t.me/example_shop/1300)") == [1300]
...
def test_link_in_eskirgan_line():
    text = (
        "1. Krossovka Nike Air · 350000 · https://t.me/example_shop/1300\n"
        "2. Dvoyka · 980000 · 2026-09-10 · https://t.me/example_shop/1234 [eskirgan]"
    )
    assert post_ids_in(text) == [1300, 1234]
