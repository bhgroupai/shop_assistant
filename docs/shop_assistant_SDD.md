...
| 0.7 | 2026-09-23 | SRS v0.5 C-2 (#23): no local models — agent and extraction on a Gemini free-tier model via `google-genai`; new `llm.py` (client, tool-schema conversion, timeouts); §1.1, §3.2, §3.7, §3.9, §7 updated; embeddings stay on Ollama until #23.5 |
